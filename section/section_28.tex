\section{Дивергенция магнитного поля. Вектор-потенциал. Кулоновская
калибровка.}
...
\begin{aligned}
    ...
    \Rightarrow
    \begin{cases}
        \mathrm{div}\vec{A}=0 \text{(Кулоновская калибровка)} \\
...
\[
\mathrm{rot}\vec{A}=\frac{1}{c}\underset{V}{\iiint} \left[ \grad \times \frac{\vec{j}(\vec{r'})}{|\vec{r}-\vec{r'}|}  \right]dV'=\frac{1}{c}\iiint \left[ \vec{j}\times \left( - \nabla \frac{1}{|\vec{r}-\vec{r'}|}  \right) \right] dV'=\vec{H} \quad \blacksquare
\]
