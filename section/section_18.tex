...
\fc{<\vec{E}>=\bigg<-\frac{\vec{d}}{r^3}+\frac{3(\vec{d}\vec{r})\vec{r}}{r^5}\bigg>=\bigg< \frac{d}{r^3}(-r^2+3z^2)\vec{e_z}\bigg>=0}
...
\begin{aligned}
	...
	\end{array}
	\Rightarrow \vec{E_{\text{л}}}=\vec{E}+\frac{4}{3}\pi\vec{P}
\end{aligned}
\]
...
\fc{
\begin{array}{l|ll}
\vec{d} = \alpha \vec{E_l}  & \Rightarrow (\varepsilon-1)\vec{E}=4\pi\vec{P}\Rightarrow\vec{E}=\frac{4\pi}{\varepsilon-1}\vec{P} \\[10pt]
...
\varepsilon \vec{E} = \vec{E} + 4 \pi \vec{P} &\qquad\qquad\qquad \boxed{\frac{\varepsilon-1}{\varepsilon+2}=\frac{4\pi}{3}n\alpha}\\
\end{array}
}