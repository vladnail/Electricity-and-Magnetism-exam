...
\fc{\frac{X''}{X}+\frac{Y''}{Y}+\frac{Z''}{Z}=0\Rightarrow\frac{X''}{X}=C_1 \Rightarrow X''=C_1X\text{ и т.д}\Rightarrow }
...
\fc{\rho =\rho _ { 1 } + \rho _ { 2 } ,\quad \Delta \varphi = - 4 \pi \rho , \quad \varphi = \varphi _ { 1 } + \varphi _ { 2 } ;}
