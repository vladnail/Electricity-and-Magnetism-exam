...
\begin{gather*}
    ...
    dW=I\varepsilon_{\text{ист}}dt=I \frac{1}{c}\frac{d\Phi}{dt}dt=\frac{1}{c}Id\Phi     
\end{gather*}
...
\begin{gather*}
    ...
    \Rightarrow \Phi_i dI_i = I_j d\Phi_j, \\
    \frac{1}{c}L_{ij}I_idI_i=I_iL_{ji}\frac{dI_i}{c} \Rightarrow (L_{ij}-L_{ji})I_idI_i=0 \Rightarrow L_{ij}=L_{ji} \quad \blacksquare 
\end{gather*}
