...
\tilde{q}_i &= \alpha q_i \text{ , } d\tilde{q_i}=q_id\alpha(0\leqslant\alpha\leqslant1)
\end{array}
}
...
\fc{\underset{V}{\iiint}\frac{E^2}{8\pi}dV=\underset{V}{\iiint}\frac{(-\grad\varphi)^2}{8\pi}dV=[\grad(\varphi\grad\varphi)=(\grad\varphi)^2+\varphi\Delta\varphi=(\grad\varphi)^2]=}
