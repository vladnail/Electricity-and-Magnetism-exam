...
\fc{\widetilde{q_i}=\alpha q_i\text{ и }\widetilde{\varphi_i}=\alpha\varphi_i\text{, где } 0\leq\alpha\leq1}
...
\fc{=-\frac{1}{8\pi}\underset{V}{\iiint}\grad(\overset{\downarrow}{\varphi}\overset{\downarrow}{\vec{D}})dV+\frac{1}{8\pi}\underset{V}{\iiint}\cancelto{0}{\varphi\grad\vec{D}}dV=}

\fc{=\underset{i}{\Sigma}\underset{S_i}{\oiint}\frac{1}{8\pi}\varphi\vec{D}d\vec{S}-\underset{S_{\infty}}{\oiint}\varphi\underset{\rightarrow0(\propto \frac{1}{r})}{\vec{D}}d\vec{S}=\frac{1}{8\pi}\underset{i}{\Sigma}\varphi_i\underset{S_i}{\oiint}\vec{D}d\vec{S}=\frac{1}{2}\underset{i}{\Sigma}\varphi_i q_i =\frac{1}{2}\varphi_i q_i} 
